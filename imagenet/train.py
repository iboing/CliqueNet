...
parser.add_argument('-g', '--gpu', default='0,1,2,3',
                    help='gpu ids used to train and validate')
...
parser.add_argument('--resume', default=None, type=str, metavar='PATH',
                    help='path to latest checkpoint model')

parser.add_argument('-s', '--save', default='./cliquenet_s0.pth.tar',
...
def save_checkpoint(state, is_best, filename):
    ...
    if is_best:
        # save as './cliquenet_s0_best.pth.tar'
